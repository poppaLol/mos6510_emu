...
fn when_addr_contains_zero_decrements_address_value_by_1() {
  ...
  assert_eq!(res.0.ram[0x03FF], 0xFF)
}
...
fn when_dec_mode_xzeropage_decrements_address_value_by_1() {
  ...
  mem.ram[0x49 + 0xA0] = 1;
  let res = dec(mem,cpu);
  assert_eq!(res.0.ram[0x49 + 0xA0], 0)
}
